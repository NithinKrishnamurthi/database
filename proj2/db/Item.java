...
public class Item {
    ...
    public static Item operate(String name, String prompt, Item i1, Item i2){
        ...
        switch (prompt){
            case "+":
                switch (type){
                    case INT: return new Item(new Column(name,type),String.valueOf(Integer.parseInt(i1.value) + Integer.parseInt(i2.value)));
                    case FLOAT: return new Item(new Column(name,type),String.valueOf(Float.parseFloat(i1.value) + Float.parseFloat(i2.value)));
                    case STRING:
